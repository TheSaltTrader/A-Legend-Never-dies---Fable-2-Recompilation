...
def main():
    ...
    for tid, w, h, fmt, tiled, pitch, endian, dim, size in uniq:
        ...
        # a full run used to decode all 196,000 dumps in pure Python to pack
        # 70,000 of them, and the decode is nearly all of phase 1.
        ...
        # so a run at new settings reuses it: the upscale is redone, the
        # decode is not. Phase 1 keeps the path, not the image - 70,000
        # decoded textures held until phase 2 were tens of gigabytes.
