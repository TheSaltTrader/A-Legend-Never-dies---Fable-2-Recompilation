"""Launch fable2 and photograph its window on a timer, without a human watching.
...
title - a title match can land on somebody else's window.
    ...
    python tools/capture.py --seconds 30 --interval 2 --outdir out/shots
"""
...
def main():
    ...
    ap.add_argument("--exe", default=None,
                    help="run this executable instead of fable2 (e.g. xenia_canary.exe)")
